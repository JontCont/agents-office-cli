# skill-token-attribution Specification

## Purpose

TBD - created by archiving change 'add-skill-token-attribution'. Update Purpose after archive.
...
<!-- @trace
source: add-skill-token-attribution
updated: 2026-06-20
code:
  ...
  - .agents/skills/test-token-attribution/SKILL.md
tests:
